...
a).update()},"new":function(){return N()},defineVars:function(a){c[3]=[a];return this},addVars:function(a){c[3].push(a);return this},getVars:function(){return c[3]},defineConf:function(a){c[4]=B(c[4],a);return this},setConf:function(a,b){c[4][a]=b;return this},getConf:function(a){return a?c[4][a]:c[4]},parseVars:function(a,b){return F(a,b?b:c[3])},objFromCss:function(a){return H(a)},cssFromObj:function(a,b,c){return w(a,b,c)},_conf:O,type:D,exportType:P,messages:t});b.defineConf(O);return b}var D=
C({rule:1,charset:2,"import":3,media:4,fontFace:5,page:6,keyframes:7,keyframe:8,namespace:10,counterStyle:11,supports:12,fontFeatureValues:14,viewport:15}),P=C({css:"css",min:"min",obj:"obj",object:"object",notMDObject:"objNMD",array:"array"}),O=C({styleId:"cssc-style",viewErr:!0,tabLen:2}),t=[];return N()}();
