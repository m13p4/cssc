...
0;d<a.length;d++)!u&&a[d]&&a[d].parentStyleSheet&&a[d].parentStyleSheet.ownerNode&&a[d].parentStyleSheet.ownerNode.id!==c[4].style_id&&P(c,a[d],b)}function P(c,a,b,d,e){var f=a.cssText.substr(0,a.cssText.indexOf("{")).trim(),h=a.type,g=b?b.c:c[0],k=r(h,4,7,12);if(!r(h,1,5,4,7,8,6,12,10,3,2))return w('index:Unsuported "'+f+'" ['+h+"]",c);r(h,10,3,2)&&(d=f=10===h?F[2]:3===h?F[1]:F[0]);var l={n:0,_s:d||f,s:f,e:a,t:h,p:b||!1,o:{},c:k?{}:!1,oc:{},io:!1,uo:!1,up:{}};k&&!e?ba(c,a.cssRules,l):k||(l.o=Y(a.cssText));
...
p&&(4===b?(l={},l[a[g]._s]=h,f.push(l)):(l=0>x.indexOf(a[g].s)?f:m,l[a[g]._s]?(7!==n(l[a[g]._s])&&(l[a[g]._s]=[l[a[g]._s]]),l[a[g]._s].push(h)):l[a[g]._s]=h));d.push(g)}if(4===b)return f;f=K(m,f);if(e){l=!1;c=0;for(g in f)if(c++,1===c)l=f[g];else break;if(1===c)return l}return f}function R(c,a){for(var b=0,d,e;b<a.length;b++)if(a[b]){if(!1!==a[b].uo)for(e in d=a[b].uo(a[b].s,E(c,[a[b]])[a[b].s]),d)q(c,a,e,d[e],b,!0);if(a[b].c)R(c,B(c,a[b],null,!0));else for(e in a[b].up)q(c,a,e,a[b].up[e](e,E(c,[a[b]],
e)),b,!0)}}function S(c,a,b,d){for(var e=r(n(b),1,2),f=0,h=[];f<a.length;f++)if(a[f])if(a[f].c&&S(c,B(c,a[f],null,!0),b,d),e){var g,k=a[f].e,l=k.parentRule?k.parentRule:k.parentStyleSheet;for(g=0;g<l.cssRules.length;g++)if(l.cssRules[g]===k){l.deleteRule(g);break}g=a[f].p?a[f].p:c[0];k=a[f].s;l=a[f];if(g&&g[k]){var m=l?g[k].e.indexOf(l):-1;l?0<=m&&(g[k].e.splice(m,1),0>=g[k].e.length&&delete g[k]):delete g[k]}}else h.push(a[f]),u||(a[f].e.style[b]=""),a[f].o[b]&&(7===n(a[f].o[b])&&S(c,a[f].o[b]),
delete a[f].o[b]);d&&(d.e=T(c,h))}function U(c,a,b,d,e){0>b&&(b+=ha(a).length);for(var f=0,h=0,g=[];f<a.length;f++)if(a[f]){if(b===h){g[f]=a[f];break}h++}return G(c,g,d,!1,e)}function T(c,a){for(var b=[],d=0;d<a.length;d++)a[d]&&b.push(u||a[d].e.placeholder?z(c,[a[d]],3):a[d].e);return b}function V(c,a,b,d){var e=n(a);if(8===e)K(c,a);else if(5===e){if(2===n(b))return c[a];c[a]=b}else{if(7===e){b={};for(d=0;d<a.length;d++)b[a[d]]=c[a[d]];return b}if(2===e)return c}return d}function G(c,a,b,d,e){function f(){if(1>
a.length&&!d&&5===n(b)){var f,k=[],l,m=e?e:[null];for(l=0;l<m.length;l++)(f=y(c,b,null,null,m[l]))&&k.push(f);a=k;h.e=T(c,a);h.selector=1===a.length?a[0].s:b}}var h=function(b){var d=0,e,g=[];for(f();d<a.length;d++)if(a[d]&&a[d].c){var h=Q(a[d].c,b,!0);for(e=0;e<h.length;e++)g.push(h[e])}return G(c,g,b,null,a)};h.e=T(c,a);h.selector=1===a.length?a[0].s:b;M(h,{set:function(b,d){f();q(c,a,b,d);return h},get:function(b,d){return E(c,a,b,d)},update:function(){R(c,a);return h},"delete":function(b){S(c,
a,b,h);return h},"export":function(b){return z(c,a,b)},parse:function(b){return J(c,a,b)},pos:function(d){return U(c,a,d,b,e)},first:function(){return U(c,a,0,b,e)},last:function(){return U(c,a,-1,b,e)}});return h}function L(){var c=[{},!1,[],{},{},{},[],{}],a=function(b){if("undefined"!==typeof this&&this.constructor===a)return L();try{return Q(c,b,!1,a)}catch(d){w("CSSC:"+d,c)}};M(a,{version:"1.0.0",init:function(b){b=7===n(b)?b:[b];for(var d=0;d<b.length;d++){var e=!1;var f=n(b[d],1);if(b[d]){b[d]=
b[d].sheet||b[d];f=b[d].href||f;try{e=b[d].cssRules||e}catch(g){f+='" -> "'+g}if(!e&&9===n(b[d])){if(b[d].e&&7===n(b[d].e)){e=b[d].e;var h="handler"}else"1.0.0"===b[d].version&&b[d].type===N?(e=b[d]().e,h="ID:"+b[d].conf().style_id):h=b[d].name;f=(e?"CSSC":f)+"["+h+"]"}}e&&0<e.length?ba(c,e,null):w("init:Can't init from \""+f+'"',c)}return a},"import":function(b){H(c,b,!1);return a},"export":function(a){return z(c,c[6],a)},parse:function(a){return J(c,c[6],a)},update:function(b){b?Q(c,b).update():
R(c,c[6]);return a},"new":function(){return L()},alias:function(b,d){var e=c[5],f=n(b),h;5===f&&(f={},f[b]=d,b=f,f=8);if(8===f)for(h in b)for(f=b[h],7!==n(f)&&(f=[f]),(h in e)||(e[h]=[]),d=0;d<f.length;d++)e[h].push(f[d]);return a},conf:function(b,d){return V(c[4],b,d,a)},vars:function(b,d){return V(c[3],b,d,a)},units:function(b,d){return V(c[7],b,d,a)},parseVars:function(a,d){return C(a,[,,,d?K({},c[3],d):c[3],c[4]])},objFromCss:function(a){return Y(a)},_conf:ca,type:N,type_export:ia,messages:X});
return a.conf(ca)}var x=["@charset","@import","@namespace","@font-face"],F=x.slice(0,3),X=[],da={Null:1,Undefined:2,Integer:3,Float:4,String:5,RegExp:6,Array:7,Object:8,Function:9},u=8===n(t),I={float:["cssFloat"]},K=9===n(Object.assign)?Object.assign:function(){var c,a,b=arguments;for(a=1;a<b.length;a++)for(c in b[a])b[0][c]=b[a][c];return b[0]},ea=9===n(Object.defineProperty)?Object.defineProperty:function(c,a,b){c[a]=b.value},ja=9===n(Object.preventExtensions),W=9===n(Object.freeze)?Object.freeze:
function(c){var a={};M(a,c);c=a;ja&&Object.preventExtensions(c);return c},ha=9===n(Object.keys)?Object.keys:function(c){var a=[],b;for(b in c)a.push(b);return a};n(Object.values);var N=W({rule:1,charset:2,"import":3,media:4,fontFace:5,page:6,keyframes:7,keyframe:8,namespace:10,counterStyle:11,supports:12,fontFeatureValues:14,viewport:15}),fa={css:1,min:2,obj:3,object:3,arr:4,array:4,objNMD:5},ia=W({css:"css",min:"min",obj:"obj",arr:"arr",object:"object",notMDObject:"objNMD",array:"array"}),ca=W({style_id:"cssc-style",
view_err:!0,parse_tab:2,parse_unit_default:"px",parse_vars_limit:100});if(u)t.exports=L();else return L()}("undefined"===typeof module?document:module);
