...
c(),d)g+=k+":"+d[k]+"; ";else g=c+":"+d+";"}d=a+"{"+g+"}";l=!1;if("@namespace"===a||"@import"===a||"@charset"===a)d=a+" "+c;try{"insertRule"in f?f.insertRule(d,h):"appendRule"in f?f.appendRule(d,h):"addRule"in f&&f.addRule(a,g,h),l=C(b,f.cssRules[h],e,a)}catch(m){c=(e?'"'+e.selector+'" > ':"")+'"'+a+'" -> '+m,b[4].view_err&&console.log(c),w.push(c)}return l?l:C(b,{csscSelector:a,cssText:d,parent:e||!1,type:N(a),placeholder:!0,cssRules:{},style:{}},e,k)}function Q(b,a,c){if(b&&b[a]){var d=c?b[a].content.indexOf(c):
-1;c?0<=d&&(b[a].content.splice(d,1),0>=b[a].content.length&&delete b[a]):delete b[a]}}function z(b,a,c){var d=n(a,1),e="A"===n(b,1)?b[0]:b;if("S"===d)return a=y(a,b[3],b[4].parse_vars_limit),c?e[a]?e[a].content:[]:t(b,e[a]?e[a].content:[],a);if("R"===d){d=[];for(var f in e)if(f.match(a))for(h=0;h<e[f].content.length;h++)d.push(e[f].content[h]);return c?d:t(b,d,a)}if("A"===d){d=[];var h;for(h=0;h<a.length;h++){var g=y(a[h],b[3],b[4].parse_vars_limit);if(e[g])for(f=0;f<e[g].content.length;f++)d.push(e[g].content[f])}return c?
d:t(b,d,a)}if("N"===d||"U"===d){d=[];for(f in e)for(h=0;h<e[f].content.length;h++)d.push(e[f].content[h]);return c?d:t(b,d,a)}return null}function A(b,a,c,d){var e=n(a,1);if("R"===e||"U"===e||"N"===e||"A"===e||"S"===e)return z(b,a,c);D(b,a);return d}function D(b,a,c,d){var e,f,h={};d||c||("@charset"in a&&(h["@charset"]=a["@charset"]),"@import"in a&&(h["@import"]=a["@import"]),"@namespace"in a&&(h["@namespace"]=a["@namespace"]),"@font-face"in a&&(h["@font-face"]=a["@font-face"]),0<v(h).length&&D(b,
h,c,!0));for(g in a)if(!(g in h)){d="A"===n(a[g],1)?a[g]:[a[g]];var g=y(g,b[3],b[4].parse_vars_limit);for(e=0;e<d.length;e++)if("@"===g.charAt(0))if("@font-face"===g||"@namespace"===g||"@import"===g||"@charset"===g)r(b,g,d[e],null,c);else{if(g.match(/^@(media|keyframes|supports)/)||c&&(4===c.type||7===c.type||12===c.type)){var l=g;(f=c)&&!g.match(/^@(media|keyframes|supports)/)&&(g=G(c.csscSelector,g),f=c.parent);var k=r(b,g,null,null,f);k&&k.selector===k.csscSelector||(k&&(O(k.indexElem),Q(k.parent?
k.parent:b[0],k.selector,k)),f={csscSelector:g,cssText:g+" {}",parent:f||!1,placeholder:!0,type:N(g),cssRules:{}},k=C(b,f,f.parent,g));D(b,d[e],k);c&&(c.obj[l]||(c.obj[l]=[]),c.obj[l].push(k))}}else n(d[e],1).match(/[Sfi]/)?(f=c?c.children:b[0],f["*"]||r(b,"*",null,null,c),p(b,[f["*"].content[0]],g,d[e])):(k=r(b,g,null,null,c))&&p(b,[k],d[e])}}function p(b,a,c,d,e){if("i"===n(e,1))if(5===a[e].indexElem.type)b[4].view_err&&console.log("@font-face rules are readonly."),w.push("@font-face rules are readonly.");
else if(c=y(c,b[3],b[4].parse_vars_limit),a[e].children)p(b,z(a[e].children,null,!0),c,d);else{var f=n(d,1);if("O"===f||"A"===f){var h="@"===c.charAt(0);f="O"===f?[d]:d;var g,l=G(a[e].selector,c);h&&(l=a[e].parent?G(a[e].parent.selector,c):c);for(g=0;g<f.length;g++)if(d=r(b,l,null,null,h?!1:a[e].parent)){if(h){var k=d;(d=r(b,a[e].selector,null,null,d))||(d=k)}p(b,[d],f[g]);h&&a[e].parent&&(k=a[e].parent,k.obj[c]&&"push"in k.obj[c]||(k.obj[c]=[]),k.obj[c].push(d.parent));a[e].obj[c]&&"push"in a[e].obj[c]||
(a[e].obj[c]=[]);a[e].obj[c].push(d)}}else if("F"===f){h=R(b,[a[e]],c);try{g=d(h),p(b,a,c,g,e),a[e].indexElem.style._update[c]=d}catch(m){b[4].view_err&&console.log(m),w.push(m)}}else b=L(d,c,b[4].parse_unit_default),a[e].indexElem.style[c]=b,a[e].obj[c]=b}else if(e=n(c,1),"O"===e?h=v(c).length:"F"===e&&(l=c()),"A"===e||"F"===e&&"A"===n(l,1))for(c="A"===e?c:l,g=0;g<c.length;g++)if(a.length>g)p(b,[a[g]],c[g]);else break;else for(g=0;g<a.length;g++)if("O"===e&&0<h)for(f in c)p(b,a,f,c[f],g);else if("F"===
e){for(f in l)p(b,a,f,l[f],g);a[g].indexElem._update=c}else p(b,a,c,d,g)}function R(b,a,c,d){if(!c)return u(b,a,"object");var e=[],f="",h;d=!!d;for(h=0;h<a.length;h++){var g="";a[h].obj[c]&&(g=a[h].obj[c],"A"===n(g,1)&&(g=u(b,g,"object")));g&&""!==g||(g=a[h].indexElem.style[c]);g&&""!==g||(g=(g=a[h].indexElem.cssText.match(new RegExp(c+"s*:s*(.+?);")))?g[1].trim():"");g&&(f=g,d&&e.push(f))}return d?e:f}function u(b,a,c,d){var e={},f,h,g,l=c;"obj"===c&&(c="object");if("arr"===c||"css"===c||"min"===
c)c="array";d||(d=[]);for(f=0;f<a.length;f++)if(!(0<=d.indexOf(a[f]))){if(10===a[f].type||3===a[f].type||2===a[f].type)var k=a[f].obj;else for(g in k=B({},a[f].obj),a[f].obj)if("A"===n(a[f].obj[g],1))if("objNMD"===c||"array"===c)k[g]=null,delete k[g];else{k[g]=[];for(h=0;h<a[f].obj[g].length;h++)if(!(0<=d.indexOf(a[f].obj[g][h]))){var m=u(b,[a[f].obj[g][h]],c,d)[a[f].obj[g][h].selector];d.push(a[f].obj[g][h]);!m||0>=v(m).length||(k[g][h]=m)}0===k[g].length?delete k[g]:1===k[g].length&&(k[g]=k[g][0])}a[f].children&&
(k=B(u(b,z(a[f].children,null,!0),c,d),k));1>v(k).length||("array"===c?(e[a[f].p]={},e[a[f].p][a[f].selector]=k):e[a[f].selector]?("A"!==n(e[a[f].selector],1)&&(e[a[f].selector]=[e[a[f].selector]]),e[a[f].selector].push(k)):e[a[f].selector]=k,d.push(a[f]))}if("array"===c)return e=v(e,!0),c===l||"arr"===l?e:x(e,"min"===l,b[4].parse_tab_len);b={};e["@charset"]&&(b["@charset"]=e["@charset"]);e["@import"]&&(b["@import"]=e["@import"]);e["@namespace"]&&(b["@namespace"]=e["@namespace"]);e["@font-face"]&&
(b["@font-face"]=e["@font-face"]);if(m=0<v(b).length)for(f in e)b[f]||(b[f]=e[f]);return m?b:e}function S(b,a){var c,d;for(c=0;c<a.length;c++){if(!1!==a[c].indexElem._update){var e=a[c].indexElem._update();for(d in e)p(b,a,d,e[d],c)}if(a[c].children)S(b,z(a[c].children,null,!0));else if(a[c].indexElem.style)for(d in a[c].indexElem.style._update)p(b,a,d,a[c].indexElem.style._update[d](),c)}}function H(b,a,c,d){var e=!!n(c,1).match(/[NU]/),f,h=[];for(f=0;f<a.length;f++)a[f].children&&H(b,z(a[f].children,
...
a.length&&!d&&"S"===n(c,1)){var f,l=[],k,m=e?e:[null];for(k=0;k<m.length;k++)(f=r(b,c,null,null,m[k]))&&l.push(f);a=l;h.e=I(b,a);h.selector=1===a.length?a[0].selector:c}}var h=function(c){var d,e,g=[];f();for(d=0;d<a.length;d++)if(a[d].children){var h=A(a[d].children,c,!0);for(e=0;e<h.length;e++)g.push(h[e])}return t(b,g,c,null,a)};h.e=I(b,a);h.selector=1===a.length?a[0].selector:c;K(h,{set:function(c,d){f();p(b,a,c,d);return h},get:function(c,d){return R(b,a,c,d)},update:function(){S(b,a);return h},
"delete":function(c){H(b,a,c,h);return h},"export":function(c){return u(b,a,c)},parse:function(c){return u(b,a,c?"min":"css")},pos:function(d){return J(b,a,d,c,e)},first:function(){return J(b,a,0,c,e)},last:function(){return J(b,a,-1,c,e)}});return h}function T(b,a,c,d){var e=n(a,1);if("O"===e)B(b,a);else if("S"===e){if("U"===n(c,1))return b[a];b[a]=c}else{if("A"===e){c={};for(d=0;d<a.length;d++)c[a[d]]=b[a[d]];return c}if("U"===e)return b}return d}function U(){var b=[{},!1,0,{},{}],a=function(c){try{return A(b,
c,!1,a)}catch(d){b[4].view_err&&console.log(d),w.push(d)}};K(a,{version:"1.0b",init:function(c){c="length"in c?c:[c];for(var d=0;d<c.length;d++)if("sheet"in c[d]&&(c[d]=c[d].sheet),"cssRules"in c[d])try{P(b,c[d].cssRules,null)}catch(e){b[4].view_err&&console.log('Cannot init CSS from "'+c[d].href+'"'),w.push('Cannot init CSS from "'+c[d].href+'"')}return a},"import":function(c){D(b,c);return a},"export":function(a){return A(b).export(a)},parse:function(a){return A(b).parse(a)},update:function(c){A(b,
c).update();return a},"new":function(){return U()},conf:function(c,d){return T(b[4],c,d,a)},vars:function(c,d){return T(b[3],c,d,a)},parseVars:function(a,d){return y(a,d?B({},b[3],d):b[3],b[4].parse_vars_limit)},objFromCss:function(a){return M(a)},cssFromObj:function(a,b,e){return x(a,b,e)},_conf:V,type:F,type_export:W,messages:w});a.conf(V);return a}var F=E({rule:1,charset:2,"import":3,media:4,fontFace:5,page:6,keyframes:7,keyframe:8,namespace:10,counterStyle:11,supports:12,fontFeatureValues:14,
viewport:15}),W=E({css:"css",min:"min",obj:"obj",arr:"arr",object:"object",notMDObject:"objNMD",array:"array"}),V=E({style_id:"cssc-style",view_err:!0,parse_tab_len:2,parse_unit_default:"px",parse_vars_limit:100}),w=[];return U()}();
