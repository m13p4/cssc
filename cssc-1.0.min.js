...
g+=l+":"+z(b[l],l,c)+"; ";else if(9===k)for(l in d=b(),d)g+=l+":"+z(d[l],l,c)+"; ";else g=b+":"+z(d,l,c)+";";g=a+" { "+g+" }";-1<A.indexOf(a)&&(g=a+" "+b);if(!t)try{var m=h.insertRule(g,h.cssRules.length)||-1;-1<m&&(f=N(c,h.cssRules[m],e,a,!0))}catch(p){v('create:"'+(e?e.s+" >> ":"")+a+'" -> '+p,c)}return f||N(c,{cssText:g,type:Y(a),placeholder:!t,cssRules:{},style:{}},e,a,!0)}function D(c,a){7!==n(a)&&(a=[a]);c=c[2];for(var b={},d=0;d<a.length;d++)c[a[d]]&&(b[a[d]]=c[a[d]]);return b}function E(c,
a,b,d){var e=n(b),g=!a;a=g?c[0]:a.c;var f=[];if(5===e)b=C(b,c),a[b]&&(f=a[b].e);else if(6===e)for(var h in a){if(b.test(h))for(e=0;e<a[h].e.length;e++)f.push(a[h].e[e])}else if(7===e)for(e=0;e<b.length;e++){if(g=C(b[e],c),a[g])for(h=0;h<a[g].e.length;h++)f.push(a[g].e[h])}else if(r(e,1,2)){if(g)return d?c[6]:H(c,c[6]);for(h in a)for(e=0;e<a[h].e.length;e++)f.push(a[h].e[e])}f=D(c,f);return d?f:H(c,f,b)}function O(c,a,b,d){var e=n(a);if(r(e,5,6,7,1,2))return E(c,!1,a,b);I(c,a,!1);return d}function I(c,
