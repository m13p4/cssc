...
y(c,m,null,null,b))&&q(c,[k],l[f])}}function q(c,a,b,d,e,f){if(a[e]){if(r(a[e].t,2,3,10,5))return w('set:Readonly rule "'+a[e].s+'" ['+a[e].t+"]",c);b=C(b,c);if(a[e].c)q(c,B(c,a[e],null,!0),b,d,!1,f);else{var h=n(d),g;if("<extend>"===b)q(c,[a[e]],d);else if("ignore"===b)console.log(d);else if(r(h,8,7)){var k="@"===b.charAt(0);var l=8===h?[d]:d,m=N(a[e].s,b);!f&&k&&(m=a[e].p?N(a[e].p.s,b):b);for(g=0;g<l.length;g++)f&&7===n(a[e].o[b])?q(c,D(c,a[e].o[b]),l[g],!1,!1,f):(d=y(c,m,null,null,k?!1:a[e].p),
...
a,b,h);return h},"export":function(b){return z(c,a,b)},parse:function(b){return J(c,a,b)},pos:function(d){return T(c,a,d,b,e)},first:function(){return T(c,a,0,b,e)},last:function(){return T(c,a,-1,b,e)}});return h}function V(){var c=[{},!1,[],{},{},{},[],{}],a=function(b){try{return P(c,b,!1,a)}catch(d){w("CSSC:"+d,c)}};L(a,{version:"1.0.0",init:function(b){b=7===n(b)?b:[b];for(var d=0;d<b.length;d++){var e=!1;var f=n(b[d],1);if(b[d]){b[d]=b[d].sheet||b[d];f=b[d].href||f;try{e=b[d].cssRules||e}catch(g){f+=
'" -> "'+g}if(!e&&9===n(b[d])){if(b[d].e&&7===n(b[d].e)){e=b[d].e;var h="handler"}else"1.0.0"===b[d].version&&b[d].type===M?(e=b[d]().e,h="ID:"+b[d].conf().style_id):h=b[d].name;f=(e?"CSSC":f)+"["+h+"]"}}e&&0<e.length?ba(c,e,null):w("init:Can't init from \""+f+'"',c)}return a},"import":function(b){H(c,b,!1);return a},"export":function(a){return z(c,c[6],a)},parse:function(a){return J(c,c[6],a)},update:function(b){b?P(c,b).update():Q(c,c[6]);return a},"new":function(){return V()},alias:function(b,
d){var e=c[5],f=n(b),h;5===f&&(f={},f[b]=d,b=f,f=8);if(8===f)for(h in b)for(f=b[h],7!==n(f)&&(f=[f]),(h in e)||(e[h]=[]),d=0;d<f.length;d++)e[h].push(f[d]);return a},conf:function(b,d){return U(c[4],b,d,a)},vars:function(b,d){return U(c[3],b,d,a)},units:function(b,d){return U(c[7],b,d,a)},parseVars:function(a,d){return C(a,[,,,d?K({},c[3],d):c[3],c[4]])},objFromCss:function(a){return Y(a)},_conf:ca,type:M,type_export:ia,messages:X});return a.conf(ca)}var x=["@charset","@import","@namespace","@font-face"],
F=x.slice(0,3),X=[],da={Null:1,Undefined:2,Integer:3,Float:4,String:5,RegExp:6,Array:7,Object:8,Function:9},u=8===n(t),I={float:["cssFloat"]},K=9===n(Object.assign)?Object.assign:function(){var c,a,b=arguments;for(a=1;a<b.length;a++)for(c in b[a])b[0][c]=b[a][c];return b[0]},ea=9===n(Object.defineProperty)?Object.defineProperty:function(c,a,b){c[a]=b.value},ja=9===n(Object.preventExtensions),W=9===n(Object.freeze)?Object.freeze:function(c){var a={};L(a,c);c=a;ja&&Object.preventExtensions(c);return c},
ha=9===n(Object.keys)?Object.keys:function(c){var a=[],b;for(b in c)a.push(b);return a};n(Object.values);var M=W({rule:1,charset:2,"import":3,media:4,fontFace:5,page:6,keyframes:7,keyframe:8,namespace:10,counterStyle:11,supports:12,fontFeatureValues:14,viewport:15}),fa={css:1,min:2,obj:3,object:3,arr:4,array:4,objNMD:5},ia=W({css:"css",min:"min",obj:"obj",arr:"arr",object:"object",notMDObject:"objNMD",array:"array"}),ca=W({style_id:"cssc-style",view_err:!0,parse_tab:2,parse_unit_default:"px",parse_vars_limit:100});
